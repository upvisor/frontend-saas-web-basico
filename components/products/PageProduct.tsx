...
import { ButtonAddToCart, ButtonNone, H1, H2, ItemCounter, ProductSlider, Spinner } from "../ui"
          ...
          <div className='w-full mt-2 lg:w-5/12 lg:mt-11'>
            ...
            }
            {
              ...
              ? product.productsOffer[0].productsSale.length
                ? <div className='mt-4 border-b pb-4 dark:border-neutral-800'>
                  <h5 className='text-[14px] tracking-widest font-semibold mb-2 md:text-[16px] dark:text-white'>OFERTAS POR LA COMPRA DE ESTE PRODUCTO</h5>
                  {
            ...
            <div ref={reviewRef} className='mt-4 border-b pb-4 dark:border-neutral-800'>
              <button onClick={(e: any) => {
                ...
                <h5 className='text-[14px] tracking-widest font-semibold md:text-[16px] dark:text-white'>DESCRIPCIÓN</h5>
                ...
                ? (
                  <div className='mt-4 pb-4 border-b dark:border-neutral-800'>
                    <button onClick={(e: any) => {
                      ...
                      <h5 className='text-[14px] tracking-widest font-semibold md:text-[16px] dark:text-white'>{design.product.titleInfo.toUpperCase()}</h5>
