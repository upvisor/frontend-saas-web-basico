      ...
      <Navbar design={design} storeData={storeData} politics={politics} style={style}>
        ...
        { children }
        {
          design.whatsapp && storeData?.phone !== ''
            ? (
              <button area-label='Botón para abrir chat por Whatsapp' id='Whatsapp' className='fixed bottom-20 right-4 z-50 w-14 h-14 flex bg-[#25D366] rounded-full shadow-md' onClick={() => {
                window.open(`https://wa.me/${storeData.phone}`, '_blank')
              }}>
