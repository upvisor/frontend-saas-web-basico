...
export const Block4 = ({ content, index, calls, forms, design, payment }: { content: IDesign, index: any, forms: IForm[], calls: ICall[], design: Design, payment: IPayment }) => {
          ...
          <div className="flex gap-4 flex-col md:flex-row">
            ...
            <div className="w-full flex flex-col gap-3 md:w-1/3">
              ...
              content.info.buttonLink3 === 'Abrir popup' || calls.find(call => call._id === content.info.buttonLink3) || forms.find(form => form._id === content.info.buttonLink3)
                ...
                }}>{content.info.button3}</Button>
                : content.info.buttonLink3 === '' || content.info.button3 === ''
                  ? ''
                  : <Link href={`${content.info.buttonLink3}`}><Button>{content.info.button3}</Button></Link>
            }
            </div>
          </div>
          {
