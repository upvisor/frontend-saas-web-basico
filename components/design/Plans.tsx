...
export const Plans: React.FC<Props> = ({ content, services, index, payment, step }) => {
  ...
  return (
    <>
      ...
      <div className="px-4 py-8 m-auto w-full flex md:py-12" style={{ background: `${content.info.typeBackground === 'Degradado' ? content.info.background : content.info.typeBackground === 'Color' ? content.info.background : ''}` }}>
