                    ...
                    if (content.content === 'Carrusel') {
                      ...
                      return (
                        <div key={content.content} className="w-full flex py-12 px-2 md:py-24">
                          <div className="w-full flex max-w-[1280px] gap-8 m-auto flex-col text-center md:flex-row md:text-left">
                      ...
                      return (
                        <div key={content.content} className="w-full flex py-12 px-2 md:py-24">
                          <div className="w-full text-center max-w-[1280px] m-auto flex flex-col gap-4">
                            <H1>{content.info.title}</H1>
                      ...
                      return (
                        <div key={content.content} className="w-full flex">
                          <div className={`${content.info.image?.url ? 'h-64 xl:h-80 2xl:h-96 text-white' : 'pt-10 pb-2'} w-full max-w-[1280px] m-auto flex flex-col gap-2`}>
