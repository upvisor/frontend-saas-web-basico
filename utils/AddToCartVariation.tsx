import { ICartProduct, IVariation } from "@/interfaces"
import axios from "axios"
import Cookies from 'js-cookie'

declare const fbq: Function

export const addToCartVariation = async ({ variation, setText, tempCartProduct, setCart, user }: { variation: IVariation, setText: any, tempCartProduct: ICartProduct, setCart: any, user: any }) => {
